...
import { Departments_academics } from '../../entities/models/admin_models_institution/Departments_academics.model';
import { Teachers } from '../../entities/models/admin_models_institution/Teachers.model';
import { Program } from '../../entities/models/admin_models_institution/Programs.model';
import { Employees } from '../../entities/models/admin_models_institution/Employees.models';
...
import { Institutions1766925750381 } from './migrations/admin_migrations/1766925750381-institutions';
import { Faculties1766925853555 } from './migrations/admin_migrations/1766925853555-faculties';
import { DepartmentsAcademics1767961580049 } from './migrations/admin_migrations/1767961580049-departments_academics';
import { Teachers1767965781165 } from './migrations/admin_migrations/1767965781165-teachers';
import { Programs1766934920847 } from './migrations/admin_migrations/1766934920847-programs';
import { Employees1766926301953 } from './migrations/admin_migrations/1766926301953-employees';
...
export const AppDataSource = new DataSource({
    ...
    entities: [Roles, Permission, Role_permission, User_role, Buildings, Users,
        User_permission, Institution, Faculty, Departments_academics, Teachers, Program, Employees,
    ...
    migrations: [Role1731800867772, Permission1737758326811, RolePermissions1767439621713, UserRoles1767057541372,
        ...
        DepartmentsAcademics1767961580049, Teachers1767965781165, Programs1766934920847, Employees1766926301953
    ],
