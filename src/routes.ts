...
import routerDpto_academics from './entities/routes/departmentsAcademics.router';
import routerTeachers from './entities/routes/teacher.router';
import routerPrograms from './entities/routes/programs.router';
